#!/bin/bash
#SBATCH --job-name=sldc_real_slides_8120497_6
#SBATCH --output=/home/mass/GRD/r.mormont/out/sldc/sldc_real_slides_8120497_6.res
#SBATCH --ntasks=64
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-datamining/algorithms/thyroid/workflow.py \
    ...
    --tile_max_width "1024" \
    --working_path "/home/mass/GRD/r.mormont/nobackup/sldc/8120497/" \
    --base_path "/api/" \
    --n_jobs 64
