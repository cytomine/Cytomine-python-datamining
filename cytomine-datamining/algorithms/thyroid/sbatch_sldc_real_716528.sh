#!/bin/bash
#SBATCH --job-name=sldc_real_slides_716528_8_second
#SBATCH --output=/home/mass/GRD/r.mormont/out/sldc/sldc_real_slides_716528_8_second.res
#SBATCH --ntasks=50
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-datamining/algorithms/thyroid/workflow.py \
    ...
    --tile_max_width "1024" \
    --working_path "/home/mass/GRD/r.mormont/nobackup/716528/sldc/" \
    --base_path "/api/" \
    --n_jobs 50