...
params = {
    ...
    'slides': [186859011, 186858563, 186851426, 186851134, 186850855, 186850602, 186850322, 186849981,
    ...
    'jobs': [187595703]  # ids of the jobs of which the annotation must be checked
}
...
class ConfusionMatrix(object):
    ...
    def __str__(self):
        ...
        for i, header in enumerate(headers):
            repre += header + ";"
            repre += ';'.join(list(map(lambda i : str(int(i)), self._matrix[i,:].tolist())))
            repre += "\n"
        return repre
