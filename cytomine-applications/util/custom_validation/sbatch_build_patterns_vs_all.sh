#!/bin/bash
#SBATCH --job-name=build_patterns_vs_all
#SBATCH --output=/home/mass/GRD/r.mormont/out/build/build_patterns_vs_all.res
#SBATCH --ntasks=10
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-applications/util/custom_validation/build.py \
    ...
    --cytomine_working_path "/home/mass/GRD/r.mormont/nobackup/build/patterns_vs_all" \
    ...
    --cytomine_positive_terms "675999,676026,933004" \
    --cytomine_negative_terms "676446,676390,676210,676434,676176,676407,15109451,15109483,15109489,15109495,8844862,8844845" \
    --pyxit_n_jobs 10 \
    --pyxit_n_subwindows 50 \
    --pyxit_min_size 0.1 \
    --pyxit_max_size 0.75 \
    --pyxit_save_to "/home/mass/GRD/r.mormont/models/patterns_vs_all.pkl" \
