#!/bin/bash
#SBATCH --job-name=build_cells_inclusion_vs_norm
#SBATCH --output=/home/mass/GRD/r.mormont/out/build/build_cells_inclusion_vs_norm.res
#SBATCH --ntasks=10
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-applications/util/custom_validation/build.py \
    ...
    --cytomine_working_path "/home/mass/GRD/r.mormont/nobackup/build/cells_inclusion_vs_norm" \
    --cytomine_id_software 30397100 \
    --cytomine_id_project 716498 \
    --cytomine_excluded_terms "675999,676026,933004,8844862,8844845,9444456,15054705,15054765,15109451,15109483,15109489,15109495,22042230,28792193,30559888" \
    --cytomine_selected_users "671279" \
    --cytomine_binary "True" \
    --cytomine_positive_terms "676390" \
    --cytomine_negative_terms "676446,676210,676434,676176,676407" \
    --pyxit_n_jobs 10 \
    --pyxit_n_subwindows 50 \
    --pyxit_min_size 0.6 \
    --pyxit_max_size 1.0 \
    --pyxit_save_to "/home/mass/GRD/r.mormont/models/cells_inclusion_vs_norm.pkl" \
