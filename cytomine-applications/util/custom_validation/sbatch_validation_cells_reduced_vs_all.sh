#!/bin/bash
#SBATCH --job-name=validation_cells_reduced_vs_all
#SBATCH --output=/home/mass/GRD/r.mormont/out/validation/validation_cells_reduced_vs_all.res
#SBATCH --ntasks=10
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-applications/util/custom_validation/validation.py \
    ...
    --cytomine_working_path "/home/mass/GRD/r.mormont/nobackup/validation/cells_reduced_vs_all" \
