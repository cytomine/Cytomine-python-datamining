#!/bin/bash
#SBATCH --job-name=validation_cell_vs_patterns
#SBATCH --output=/home/mass/GRD/r.mormont/out/validation/validation_cell_vs_patterns.res
#SBATCH --ntasks=10
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-applications/util/custom_validation/validation.py \
    ...
    --cytomine_working_path "/home/mass/GRD/r.mormont/nobackup/validation/cells_vs_patterns" \
    --cytomine_id_software 179703916 \
    --cytomine_id_project 716498 \
    --cytomine_excluded_terms "8844862,8844845,9444456,22042230,28792193,30559888,15054705,15054765" \
