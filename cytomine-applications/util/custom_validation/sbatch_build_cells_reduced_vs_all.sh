#!/bin/bash
#SBATCH --job-name=build_cells_reduced_vs_all
#SBATCH --output=/home/mass/GRD/r.mormont/out/build/build_cells_reduced_vs_all.res
#SBATCH --ntasks=10
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-applications/util/custom_validation/build.py \
    ...
    --cytomine_working_path "/home/mass/GRD/r.mormont/nobackup/build/cells_reduced_vs_all" \
    ...
    --cytomine_negative_terms "675999,676026,933004,8844862,8844845,15109451,15109483,15109489,15109495" \
    --pyxit_n_jobs 10 \
    --pyxit_n_subwindows 50 \
    --pyxit_min_size 0.6 \
    --pyxit_max_size 1.0 \
    --pyxit_save_to "/home/mass/GRD/r.mormont/models/cells_reduced_vs_all.pkl" \
