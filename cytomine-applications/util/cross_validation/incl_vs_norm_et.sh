#!/bin/bash
#SBATCH --job-name=incl_vs_norm_et
#SBATCH --output=/home/mass/GRD/r.mormont/out/validation/final/incl_vs_norm_et.res
#SBATCH --ntasks=120
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-applications/util/cross_validation/pyxit_cross_validator.py \
    ...
    --cytomine_verbose 0 \
    --pyxit_n_jobs 120 \
    --pyxit_save_to "/home/mass/GRD/r.mormont/models/validated/final/incl_vs_norm_et.pkl" \
    ...
    --forest_min_samples_split 1 \
    	--forest_min_samples_split 108 \
    	--forest_min_samples_split 1075 \
    	--forest_min_samples_split 2150 \
    	--forest_min_samples_split 5375 \
