#!/bin/bash
#SBATCH --job-name=incl_vs_norm_reviewed_svm_non
#SBATCH --output=/home/mass/GRD/r.mormont/out/validation/final/incl_vs_norm_reviewed_svm_non.res
#SBATCH --ntasks=87
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-applications/util/cross_validation/pyxit_cross_validator.py \
    ...
    --cytomine_verbose 0 \
    --pyxit_n_jobs 87 \
    --pyxit_save_to "/home/mass/GRD/r.mormont/models/validated/final/incl_vs_norm_reviewed_svm_non.pkl" \
