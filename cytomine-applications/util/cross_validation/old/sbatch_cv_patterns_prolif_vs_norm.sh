#!/bin/bash
#SBATCH --job-name=cv_prolif_vs_norm_build_no_svm
#SBATCH --output=/home/mass/GRD/r.mormont/out/validation/cv_prolif_vs_norm_build_no_svm.res
#SBATCH --ntasks=120
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-applications/util/cross_validation/pyxit_cross_validator.py \
    ...
    --pyxit_save_to "/home/mass/GRD/r.mormont/models/validated/prolif_no_svm.pkl" \
    --cytomine_verbose 0 \
    --cv_images_out 1 \
    --pyxit_n_jobs 120 \
