#!/bin/bash
#SBATCH --job-name=cpo_reviewed_svm
#SBATCH --output=/home/mass/GRD/r.mormont/out/validation/final/cpo_reviewed_svm.res
#SBATCH --ntasks=87
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-applications/util/cross_validation/pyxit_cross_validator.py \
    ...
    --cytomine_verbose 0 \
    --pyxit_n_jobs 87 \
    --pyxit_save_to "/home/mass/GRD/r.mormont/models/validated/final/cpo_reviewed_svm.pkl" \
