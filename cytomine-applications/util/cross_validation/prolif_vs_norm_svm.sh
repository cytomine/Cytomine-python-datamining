#!/bin/bash
#SBATCH --job-name=prolif_vs_norm_svm
#SBATCH --output=/home/mass/GRD/r.mormont/out/validation/final/prolif_vs_norm_svm.res
#SBATCH --ntasks=120
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-applications/util/cross_validation/pyxit_cross_validator.py \
    ...
    --cytomine_verbose 0 \
    --pyxit_n_jobs 120 \
    --pyxit_save_to "/home/mass/GRD/r.mormont/models/validated/final/prolif_vs_norm_svm.pkl" \
