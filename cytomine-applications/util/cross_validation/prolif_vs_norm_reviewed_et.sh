#!/bin/bash
#SBATCH --job-name=prolif_vs_norm_reviewed_et
#SBATCH --output=/home/mass/GRD/r.mormont/out/validation/final/prolif_vs_norm_reviewed_et.res
#SBATCH --ntasks=120
...
/home/mass/GRD/r.mormont/miniconda/bin/python /home/mass/GRD/r.mormont/sftp/cytomine-applications/util/cross_validation/pyxit_cross_validator.py \
    ...
    --cytomine_positive_terms 676026 \
        --cytomine_positive_terms 933004 \
    --cytomine_negative_terms 675999 \
    --cytomine_excluded_terms 676446 \
        --cytomine_excluded_terms 676390 \
        --cytomine_excluded_terms 676210 \
        --cytomine_excluded_terms 676434 \
        --cytomine_excluded_terms 676176 \
        --cytomine_excluded_terms 676407 \
        ...
        --cytomine_excluded_terms 15109483 \
        --cytomine_excluded_terms 15109489 \
    ...
    --cytomine_verbose 0 \
    --pyxit_n_jobs 120  \
    --pyxit_save_to "/home/mass/GRD/r.mormont/models/validated/final/prolif_vs_norm_reviewed_et.pkl" \
    ...
    --forest_min_samples_split 1 \
    	--forest_min_samples_split 76 \
    	--forest_min_samples_split 756 \
    	--forest_min_samples_split 1511 \
    	--forest_min_samples_split 3778 \
