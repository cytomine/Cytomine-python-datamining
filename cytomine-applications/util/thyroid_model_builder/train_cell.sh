...
model_file="$_HOME/models/cell_model_better.pkl"
...
min_size=0.5 #minimum size of subwindows (proportionnaly to image size: 0.1 means minimum size is 10% of min(width,height) of original image
max_size=1.0 #maximum size of subwindows (...)
