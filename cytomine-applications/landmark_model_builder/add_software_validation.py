...
software = conn.add_software("Landmark_Model_Validation", "pyxitSuggestedTermJobService","ValidateAnnotation")
...
conn.add_software_parameter("validation_K",             software.id, "Number", None, True, 11, False)
conn.add_software_parameter("validation_result_mean",   software.id, "Number", None, True, 11, False)
