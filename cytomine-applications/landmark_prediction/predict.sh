...
python landmark_predict.py --cytomine_host $host --cytomine_public_key $public_key --cytomine_private_key $private_key --cytomine_id_software $id_software --cytomine_base_path $base_path --cytomine_working_path $working_path --cytomine_id_project $id_project --model_load_from $model_path --model_names $model_names --image_type $image_type --verbose $verbosity
